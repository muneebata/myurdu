...
CSS = """html[data-theme=dark] body{background:url("../jali/chishti-dark.svg?v=2"), #0f2429;background-size:72px 124.7px;color:#f0e6cf}
...
body{margin:0;background:url("../jali/jahangir-light.svg?v=2") ,#faf3e1;background-size:26px 45px;color:#3b2e1f;font-family:-apple-system,'Segoe UI',Roboto,sans-serif;line-height:1.6}
