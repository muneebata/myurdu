...
const TRACE_LETTERS = [
  ...
  { ch: "ج", name: "jīm", hint: "The head bar right-to-left, then the big bowl — then the dot inside.", strokes: [{ p: "M144,98 C126,92 104,93 84,102" }, { p: "M84,102 C70,116 62,134 66,154 C70,176 92,192 118,188 C132,185 140,178 142,170" }, { d: [102, 140] }] },
  { ch: "چ", name: "che", hint: "Head bar, bowl — then three dots in the bowl.", strokes: [{ p: "M144,98 C126,92 104,93 84,102" }, { p: "M84,102 C70,116 62,134 66,154 C70,176 92,192 118,188 C132,185 140,178 142,170" }, { d: [90, 132] }, { d: [114, 132] }, { d: [102, 148] }] },
  { ch: "ح", name: "baṛī he", hint: "Head bar, then the bowl — and no dots at all.", strokes: [{ p: "M144,98 C126,92 104,93 84,102" }, { p: "M84,102 C70,116 62,134 66,154 C70,176 92,192 118,188 C132,185 140,178 142,170" }] },
  { ch: "خ", name: "khe", hint: "Head bar, bowl — then one dot on top.", strokes: [{ p: "M144,98 C126,92 104,93 84,102" }, { p: "M84,102 C70,116 62,134 66,154 C70,176 92,192 118,188 C132,185 140,178 142,170" }, { d: [112, 70] }] },
  ...
  { ch: "ص", name: "swād", hint: "The loop first, flowing into the tail.", strokes: [{ p: "M168,112 C168,100 148,97 138,105 C129,113 136,126 150,126 C160,126 166,120 168,112" }, { p: "M138,116 C124,150 100,175 72,179 C50,182 36,166 40,150" }] },
  { ch: "ض", name: "zwād", hint: "Swād, then one dot above.", strokes: [{ p: "M168,112 C168,100 148,97 138,105 C129,113 136,126 150,126 C160,126 166,120 168,112" }, { p: "M138,116 C124,150 100,175 72,179 C50,182 36,166 40,150" }, { d: [152, 74] }] },
  { ch: "ط", name: "to'e", hint: "The loop and base first, then the standing alif.", strokes: [{ p: "M126,117 C108,106 74,110 64,124 C58,133 69,141 92,141 C112,141 124,132 126,122" }, { p: "M126,52 L126,146" }] },
  { ch: "ظ", name: "zo'e", hint: "Like to'e — loop, alif, then the dot.", strokes: [{ p: "M126,117 C108,106 74,110 64,124 C58,133 69,141 92,141 C112,141 124,132 126,122" }, { p: "M126,52 L126,146" }, { d: [110, 100] }] },
  ...
  { ch: "ک", name: "kāf", hint: "The body first, then the flag stroke on top.", strokes: [{ p: "M150,54 C138,68 118,84 104,94" }, { p: "M104,94 C84,108 62,126 60,136 C60,146 84,148 112,146 C128,145 142,141 150,134" }] },
  { ch: "گ", name: "gāf", hint: "Kāf, plus a second flag — gāf's signature.", strokes: [{ p: "M142,38 C128,52 112,66 98,78" }, { p: "M150,54 C138,68 118,84 104,94" }, { p: "M104,94 C84,108 62,126 60,136 C60,146 84,148 112,146 C128,145 142,141 150,134" }] },
