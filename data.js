...
const TRACE_LETTERS = [
  ...
  { ch: "ج", name: "jīm", hint: "The head bar right-to-left, then the big bowl — then the dot inside.", strokes: [{ p: "M140,96 C126,92 106,94 90,104" }, { p: "M90,104 C112,110 126,124 124,148 C120,176 92,192 68,174" }, { d: [100, 148] }] },
  { ch: "چ", name: "che", hint: "Head bar, bowl — then three dots in the bowl.", strokes: [{ p: "M140,96 C126,92 106,94 90,104" }, { p: "M90,104 C112,110 126,124 124,148 C120,176 92,192 68,174" }, { d: [88, 140] }, { d: [112, 140] }, { d: [100, 158] }] },
  { ch: "ح", name: "baṛī he", hint: "Head bar, then the bowl — and no dots at all.", strokes: [{ p: "M140,96 C126,92 106,94 90,104" }, { p: "M90,104 C112,110 126,124 124,148 C120,176 92,192 68,174" }] },
  { ch: "خ", name: "khe", hint: "Head bar, bowl — then one dot on top.", strokes: [{ p: "M140,96 C126,92 106,94 90,104" }, { p: "M90,104 C112,110 126,124 124,148 C120,176 92,192 68,174" }, { d: [112, 70] }] },
  ...
  { ch: "ع", name: "ain", hint: "The little top curve, then the big open belly.", strokes: [{ p: "M138,86 C120,79 106,88 108,102 C110,113 124,117 138,112" }, { p: "M108,102 C130,116 141,133 133,155 C124,181 92,193 70,176" }] },
  { ch: "غ", name: "ghain", hint: "Ain, then one dot on top.", strokes: [{ p: "M138,86 C120,79 106,88 108,102 C110,113 124,117 138,112" }, { p: "M108,102 C130,116 141,133 133,155 C124,181 92,193 70,176" }, { d: [122, 58] }] },
