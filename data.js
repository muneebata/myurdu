...
const TRACE_LETTERS = [
  ...
  { ch: "د", name: "dāl", hint: "One stroke: down from the tip, then sweep along the floor.", strokes: [{ p: "M115,93 C119,108 119,122 112,133 C104,145 88,148 76,141" }] },
  { ch: "ڈ", name: "ḍāl", hint: "Dāl first, then the little ta-mark on top.", strokes: [{ p: "M115,93 C119,108 119,122 112,133 C104,145 88,148 76,141" }, { p: "M100,52 L100,65 C100,70 93,71 89,68 C85,64 87,57 93,57 C97,57 99,60 100,63" }] },
  { ch: "ذ", name: "zāl", hint: "Dāl, then one dot above.", strokes: [{ p: "M115,93 C119,108 119,122 112,133 C104,145 88,148 76,141" }, { d: [102, 68] }] },
  ...
  { ch: "ط", name: "to'e", hint: "The loop and base first, then the standing alif.", strokes: [{ p: "M124,120 C106,109 72,113 62,127 C56,136 67,144 90,144 C110,144 122,135 124,125" }, { p: "M134,52 L134,146" }] },
  { ch: "ظ", name: "zo'e", hint: "Like to'e — loop, alif, then the dot.", strokes: [{ p: "M124,120 C106,109 72,113 62,127 C56,136 67,144 90,144 C110,144 122,135 124,125" }, { p: "M134,52 L134,146" }, { d: [110, 100] }] },
  { ch: "ع", name: "ain", hint: "The little top curve, then the big open belly.", strokes: [{ p: "M132,84 C114,78 100,88 102,102 C104,112 118,116 132,112" }, { p: "M102,104 C82,116 66,136 68,156 C70,178 92,193 120,188 C134,184 142,176 144,168" }] },
  { ch: "غ", name: "ghain", hint: "Ain, then one dot on top.", strokes: [{ p: "M132,84 C114,78 100,88 102,102 C104,112 118,116 132,112" }, { p: "M102,104 C82,116 66,136 68,156 C70,178 92,193 120,188 C134,184 142,176 144,168" }, { d: [116, 56] }] },
  ...
  { ch: "ھ", name: "do-chashmī he", hint: "Two little eyes: right one, then left one.", strokes: [{ p: "M134,90 C120,86 108,94 108,106 C108,116 118,122 128,118" }, { p: "M108,106 C104,94 90,88 80,96 C72,104 76,116 88,118" }, { p: "M140,120 C120,148 80,152 58,136" }] },
  { ch: "ء", name: "hamza", hint: "One small hook, like a tiny 2.", strokes: [{ p: "M124,116 C112,106 96,110 94,122 C92,132 102,138 112,136" }, { p: "M112,136 C104,140 96,146 92,152" }] },
  { ch: "ی", name: "choṭī ye", hint: "The deep boat with its curl, then two dots below.", strokes: [{ p: "M134,104 C140,130 122,158 92,164 C74,167 64,156 68,142" }] },
