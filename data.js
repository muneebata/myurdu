...
const GEO_FEATURES = [
  ...
  { id: "mohenjodaro", type: "site", name: "Mohenjo-daro", ur: "موئن جو دڑو", tr: "Moen jo Daṛo", blurb: "The great Indus Valley metropolis of ~2500 BCE — a UNESCO site with the famous Great Bath, quietly abandoned four millennia ago." },
  { id: "shalimar", type: "site", name: "Shalimar Gardens", ur: "شالیمار باغ", tr: "Shālīmār Bāgh", blurb: "Lahore's Mughal garden of terraces and fountains, laid out under Shah Jahan in the 1640s — UNESCO-listed together with Lahore Fort." },
  { id: "faisalmosque", type: "site", name: "Faisal Mosque", ur: "فیصل مسجد", tr: "Faisal Masjid", blurb: "Islamabad's tent-shaped national mosque, completed in 1986 and long among the world's largest — named for Saudi King Faisal, who funded it." },
  { id: "katasraj", type: "site", name: "Katas Raj Temples", ur: "کٹاس راج", tr: "Kaṭās Rāj", blurb: "Ancient Hindu temples ringing a sacred pond in the Salt Range — a pilgrimage site for many centuries." },
  { id: "ranikot", type: "site", name: "Ranikot Fort", ur: "رنی کوٹ", tr: "Rānīkoṭ", blurb: "The 'Great Wall of Sindh' — ramparts marching for kilometres across the Kirthar hills, among the largest forts anywhere." },
  { id: "shandur", type: "site", name: "Shandur Pass", ur: "شندور", tr: "Shandūr", blurb: "The 'roof of the world' pass at ~3,700 m, where Chitral and Gilgit teams meet each July for the world's highest polo festival." },
  { id: "ziarat", type: "site", name: "Ziarat", ur: "زیارت", tr: "Ziyārat", blurb: "A hill town amid one of the world's great juniper forests — the Quaid-e-Azam spent his final days at its famous Residency." },
  { id: "rakaposhi", type: "feature", name: "Rakaposhi", ur: "راکاپوشی", tr: "Rākāposhī", blurb: "A 7,788-metre Karakoram giant looming over Hunza — famous for one of the tallest unbroken mountain rises on Earth." },
  { id: "deosai", type: "feature", name: "Deosai Plains", ur: "دیوسائی", tr: "Deosāī", blurb: "The 'Land of Giants' — a plateau around 4,100 m of summer wildflowers and Himalayan brown bears, among the highest plains on Earth." },
  { id: "hunza", type: "feature", name: "Hunza Valley", ur: "ہنزہ", tr: "Hunzā", blurb: "The storied northern valley beneath Rakaposhi — terraced apricot orchards, Karimabad, and the old Baltit Fort." },
  { id: "swat", type: "feature", name: "Swat Valley", ur: "سوات", tr: "Swāt", blurb: "The green river valley once dubbed 'the Switzerland of the East' — rich in Buddhist Gandhara heritage, and Malala Yousafzai's home." },
  { id: "kalash", type: "feature", name: "Kalash Valleys", ur: "کالاش", tr: "Kālāsh", blurb: "Three Hindu Kush valleys of the Kalash people, whose language and festivals survive nowhere else on Earth." },
  { id: "gilgit", type: "city", name: "Gilgit", ur: "گلگت", tr: "Gilgit", blurb: "Capital of Gilgit-Baltistan — the crossroads town where the Karakoram Highway threads toward China." },
  { id: "muzaffarabad", type: "city", name: "Muzaffarabad", ur: "مظفرآباد", tr: "Muzaffarābād", blurb: "Capital of Azad Jammu & Kashmir, set where the Neelum meets the Jhelum." },
  { id: "abbottabad", type: "city", name: "Abbottabad", ur: "ایبٹ آباد", tr: "Aibṭābād", blurb: "The pine-ringed hill city on the road north — gateway to the Karakoram Highway and summer escape since colonial days." },
];
...
const KUTUB = [
  ...
  },
  {
    ...
    title: "Shikwa & Jawāb — The Complaint and the Answer",
    form: "excerpts, from Bāng-e-Darā, 1924",
    intro: "In 1909 Iqbal did something audacious: he filed a formal complaint against God — politely, in magnificent Urdu — asking why the faithful had fallen so far. The scandal was immediate. Four years later he published God's reply, Jawāb-e-Shikwa, whose closing promise became one of the most quoted couplets in the language. Openings of both, here; the full poems are long, magnificent, and public domain.",
    source: "Bāng-e-Darā, 1924 (public domain, incl. US pre-1930).",
    lines: [
      { ur: "کیوں زیاں کار بنوں سود فراموش رہوں", tr: "kyūṉ ziyāṉ-kār banūṉ sūd-farāmosh rahūṉ", en: "Why should I choose loss, forgetful of gain?", note: "Ziyāṉ = loss, sūd = profit — the ledger of a Lahore that was also a trading city. The Complaint opens like an audit." },
      { ur: "فکر فردا نہ کروں محو غم دوش رہوں", tr: "fikr-e-fardā na karūṉ mahv-e-gham-e-dosh rahūṉ", en: "Why not think of tomorrow — why stay drowned in yesterday's grief?", note: "Fardā = tomorrow, dosh = yesterday (the high-Persian kal, both directions at once)." },
      { ur: "اے خدا شکوۂ اربابِ وفا بھی سن لے", tr: "ai khudā shikwa-e-arbāb-e-wafā bhī sun le", en: "O God — hear too this complaint from the people of faithfulness;", note: "Shikwa = complaint; arbāb-e-wafā = the keepers of loyalty. Sun le — L23's compound le, softening a demand into a plea." },
      { ur: "خوگرِ حمد سے تھوڑا سا گلہ بھی سن لے", tr: "khūgar-e-hamd se thoṛā sā gilā bhī sun le", en: "from one accustomed to praise, hear a little grievance.", note: "Thoṛā sā — 'just a little' — the same softener as thoṛā break. Even complaining to God, Urdu stays polite." },
      { ur: "کی محمد سے وفا تو نے تو ہم تیرے ہیں", tr: "kī muhammad se wafā tū ne to ham tere haiṉ", en: "Be faithful to Muhammad, and We are yours —", note: "From the Jawāb — God's reply, four years later. The agar/jab…to hinge from Level 22, holding the answer's promise." },
      { ur: "یہ جہاں چیز ہے کیا لوح و قلم تیرے ہیں", tr: "ye jahāṉ chīz hai kyā lauh-o-qalam tere haiṉ", en: "this world is nothing — the Tablet and the Pen are yours.", note: "Lauh-o-qalam — the cosmic Tablet and Pen. Chīz kyā hai = 'what is this thing?' — everyday words, cosmic scale. Perhaps the most recited Iqbal couplet of all." },
    ],
  },
];
